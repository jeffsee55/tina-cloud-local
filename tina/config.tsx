...
const config = defineConfig({
  ...
  tinaioConfig: {
    ...
    contentApiUrlOverride:
      process.env.NEXT_PUBLIC_TINA_CONTENT_URL ||
      "https://content.identity-james1.tinajs.dev",
    identityApiUrlOverride:
      process.env.NEXT_PUBLIC_TINA_IDENTITY_URL ||
      "https://identity.identity-james1.tinajs.dev",
    assetsApiUrlOverride:
      process.env.NEXT_PUBLIC_TINA_ASSETS_URL ||
      "https://assets-api-local-james1.tinajs.dev",
    // PR
